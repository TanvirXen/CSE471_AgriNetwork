                ...
                <div key={escrow._id} className="esc-tx-card" style={{ animationDelay: `${i * 0.07}s` }}>
                  ...
                  <div className="esc-tx-top">
                    <div className="esc-tx-info">
                      ...
                      <div className="esc-tx-id">ID: {escrow._id} · Order: {escrow.orderId}</div>
                    </div>
                  ...
                  <div className="esc-tx-body">
                    ...
                    <div className="esc-parties">
                      <div className="esc-party">
                        <div className="esc-party-avatar avatar-buyer">{initials(escrow.buyerId?.name || 'B')}</div>
                        <div className="esc-party-info">
                          <div className="esc-party-role">Buyer</div>
                          <div className="esc-party-name">{escrow.buyerId?.name || 'Unknown Buyer'}</div>
                        </div>
                      </div>
                      <div className="esc-party">
                        <div className="esc-party-avatar avatar-seller">{initials(escrow.sellerId?.name || 'S')}</div>
                        <div className="esc-party-info">
                          <div className="esc-party-role">Seller</div>
                          <div className="esc-party-name">{escrow.sellerId?.name || 'Unknown Seller'}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {isExpanded && (
                    <div style={{ marginTop: '1rem', padding: '1rem', background: '#fafaf8', borderRadius: '10px', fontSize: '0.84rem', color: 'var(--text-muted)', lineHeight: '1.7' }}>
                      ...
                      <div><strong style={{ color: 'var(--primary-dark)' }}>Order ID:</strong> {escrow.orderId}</div>
