...
const { createBuyRequest, getMyBuyRequests, deleteBuyRequest, getPublicBuyRequests } = require('../controllers/buyRequestController');
...
// @desc    Get all public procurement demands
router.get('/public', auth, getPublicBuyRequests);
