...
exports.createListing = async (req, res) => {
  try {
    ...
    const newFarmerListing = new FarmerListing({
      sellerId: req.user ? req.user.id : "640a1b2c3d4e5f6a7b8c9d0e", 
      title: productName,
      productName,
      ...
      region: harvestOrigin, // [FIX] Map harvestOrigin to region for persistence
      district: harvestOrigin, // [FIX] Also map to district for broader compatibility
    ...
    const marketProduct = new MarketProduct({
      ...
      price: finalPrice,
      quality: grade || 'A',
      image: finalImageUrl, // [NEW] Save custom image to Marketplace
